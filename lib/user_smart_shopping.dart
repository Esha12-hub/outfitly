...
class UserSmartShoppingScreen extends StatefulWidget {
  const UserSmartShoppingScreen({super.key});

  @override
  State<UserSmartShoppingScreen> createState() => _UserSmartShoppingScreenState();
}

class _UserSmartShoppingScreenState extends State<UserSmartShoppingScreen> {
