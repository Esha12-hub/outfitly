...
class _VerifyEmailScreenState extends State<VerifyEmailScreen> {
  ...
  String? _selectedOption; // 'email' or 'phone'
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text('Select verification method:', style: TextStyle(fontWeight: FontWeight.bold)),
                  ListTile(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Secure your account by verifying your selected contact method.',
                          style: TextStyle(
                            fontSize: 14,
                        ...
                        // Show only the selected verification section
  ...
  void _sendEmailCode() {
    if (_selectedOption != 'email') return;
  ...
  void _sendPhoneCode() {
    if (_selectedOption != 'phone') return;
  ...
  void _saveVerification() async {
    if ((_selectedOption == 'email' && !_isEmailVerified) ||
        (_selectedOption == 'phone' && !_isPhoneVerified) ||
        _selectedOption == null) {
      _showSnackBar('Please select and verify your contact method first', bgColor: Colors.red);
      return;
    }
